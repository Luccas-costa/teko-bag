...
export default function VitrineHeader() {
  ...
  return (
    <header className='w-full py-3 flex justify-between items-center px-2 space-x-2'>
      <div className='rounded-xl 2xl:w-[88%] lg:w-[82%] md2:w-[80%] sm1:w-[72%] xm1:w-[70%] xm2:w-[65%] sm2:w-[65%] xm6:w-[62%] w-[59%] bg-white/15 xm5:py-[0.6rem] xm7:py-[0.6rem] py-[0.9rem] px-3 shadow-lg'>
      ...
      <div className='rounded-xl 2xl:w-[12%] lg:w-[18%] md2:w-[20%] sm1:w-[28%] xm1:w-[30%] xm2:w-[35%] sm2:w-[35%] xm6:w-[38%] w-[41%] bg-white/15 py-1 px-3 shadow-lg'>
