...
export default function DashboardFuncoes({
  ...
  return (
    <div className='h-[40px] w-full border-t border-zinc-700 dash10:px-5 dash10_5:px-2 flex items-center dash9:text-base dash10:text-sm dash10_5:text-xs text-zinc-400 font-semibold justify-between shadow-lg shadow-zinc-900'>
      ...
      <div className='flex mr-2 dash9:space-x-12 dash10:space-x-2 dash10_5:space-x-2'>
        <div>
          {" "}
        ...
        <div className='flex space-x-2'>
          <div
            className='dash9_5:w-6 dash9_5:h-6 dash10:w-5 dash10:h-5 dash10_5:w-5 dash10_5:h-5 bg-zinc-600 flex items-center justify-center shadow-lg border border-zinc-500 rounded cursor-pointer'
