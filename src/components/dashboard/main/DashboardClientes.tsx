...
export default function DashboardClientes({
  ...
  return (
    <div className='h-[80px] w-full border-y border-zinc-700 dash8:px-5 dash8_5:px-2 dash9:px-2 dash10:px-2 flex items-center text-zinc-300 font-semibold shadow-lg shadow-zinc-900 relative'>
      ...
      ></input>
      <div className='dash3:w-[10rem] dash4:w-[7rem] dash5:w-[6rem] dash6:w-[5rem] dash6:text-base dash7:w-[5rem] dash8:w-[5rem] dash8_5:w-[3.8rem] dash7:text-sm dash9:text-xs dash10:text-[11px] dash10_5:text-[11px] dash9:w-[4rem] dash10:w-[3rem] text-zinc-400'>
        {id}
      </div>
      <div className='dash1:w-[28rem] dash2:w-[19rem] dash3:w-[15rem] dash4:w-[14rem] dash5:w-[13rem] dash6:w-[12rem] dash6:text-base dash7:w-[10.5rem] dash7:text-sm dash8:w-[9rem] dash8_5:w-[9rem] dash9:text-xs dash10:text-[11px] dash10_5:text-[11px] dash9:w-[8.5rem] dash9_5:w-[8rem] dash10:w-[7.6rem] flex flex-col truncate overflow-hidden'>
        <div>{nome}</div>
        <div className='text-zinc-500 dash7:text-sm dash8:text-xs dash10_5:text-[10px]'>
          {email}
        </div>
      </div>
      <div className='dash1:w-[22.4rem] dash2:w-[18rem] dash3:w-[15rem] dash4:w-[14rem] dash5:w-[13rem] dash6:w-[10rem] dash6:text-base dash7:w-[8rem] dash7:text-sm dash8:w-[7.5rem] dash9:w-[7.5rem] dash9_5:w-[6.5rem] dash9:text-xs dash10:text-[11px] dash10_5:text-[11px] dash10:w-[5rem] text-zinc-400'>
