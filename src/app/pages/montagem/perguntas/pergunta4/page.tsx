      ...
      <div className='p-3 2xl:w-1/4 md:w-1/2  w-4/5 border border-zinc-950 rounded-lg flex flex-col items-center justify-center shadow-lg my-auto'>
        ...
        <div className='grid grid-cols-3 gap-4 mt-6'>
          {options.map((option) => (
            <div
              key={option.id}
              className={`lg:w-40 sm:w-24 w-20 h-20 ${option.bgColor} flex items-center justify-center rounded-lg border-l-[1px] border-b-[5px] cursor-pointer  ${selectedOption === option.id ? "border-banner5" : "border-black"}`}
